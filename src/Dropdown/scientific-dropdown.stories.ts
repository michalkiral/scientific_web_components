...
export const DarkTheme: Story = {
  args: {
    ...
    options: [
      ...
      {label: 'Statistical Modeling', value: 'stats'},
    ],
    searchable: true,
    clearable: true,
    placeholder: 'Select research area...',
  },
  render: ({label, theme, options, searchable, clearable, placeholder}) =>
    html`<scientific-dropdown
      .label=${label}
      .theme=${theme}
      .options=${options}
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Dropdown with dark theme applied, featuring dark backgrounds and light text optimized for low-light usage.',
      },
    },
  },
};
...
export const ScientificTheme: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Dropdown with scientific theme featuring professional typography, enhanced shadows, and research-focused styling.',
      },
    },
  },
};
